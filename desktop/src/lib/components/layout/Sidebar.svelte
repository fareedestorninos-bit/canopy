...
<aside class="sb-sidebar" class:collapsed={isCollapsed} aria-label="Main navigation">
  ...
  <nav class="sb-nav" aria-label="Sidebar navigation">
    ...
    <div class="sb-core">
      ...
      <SidebarNavItem href="/app/inbox" label="Inbox" icon={ICONS.inbox} shortcut={!isCollapsed ? '⌘2' : undefined} badge={(approvalsStore.pendingCount + notificationsStore.unreadCount) || undefined} active={isActive('/app/inbox')} />
    ...
    {#if !isCollapsed}
      ...
      <SidebarSection label="Observe">
        ...
        <SidebarNavItem href="/app/reports" label="Reports" icon={ICONS.reports} active={isActive('/app/reports')} />
      </SidebarSection>
